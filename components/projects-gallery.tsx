...
const projects: Project[] = [
  {
    id: 'pekanristek-ctf-challenge',
    title: 'PekanRistek CTF Challenge',
    description: 'Custom university web exploitation challenges focused on SSTI, unrestricted upload, and remote code execution chains.',
    longDescription: 'Built challenge infrastructure and exploitation paths for PekanRistek CTF, centered on web security concepts such as server-side template injection, unrestricted file upload, and practical remote code execution escalation. The project was designed to sharpen offensive security intuition while staying teachable for university-level players.',
    technologies: ['Web Exploitation', 'Vulnerability Research', 'SSTI', 'RCE', 'Application Security'],
    category: 'security',
    image: '/images/projects/pekanristek-ctf-challenge.png',
    githubUrl: 'https://github.com/rakabimar/ctf-challenges',
    featured: true,
    status: 'completed'
  },
  {
    id: 'microservices-restaurant-platform',
    title: 'Microservices Restaurant Platform',
    description: 'Microservices-based restaurant platform built with secure backend patterns, cloud deployment, and CI/CD delivery.',
    longDescription: 'Developed a restaurant platform using Spring Boot microservices and Next.js, deployed on AWS EC2 with CI/CD workflows. The project included JWT-based authentication, secret management, and service-oriented delivery practices to keep the system modular and production-ready.',
    technologies: ['Spring Boot', 'Next.js', 'AWS EC2', 'CI/CD', 'JWT', 'Microservices'],
    category: 'web',
    image: '/images/projects/microservices-restaurant-platform.png',
    githubUrl: 'https://github.com/orgs/AdPro-A17/repositories',
    featured: true,
    status: 'completed'
  },
  {
    id: 'sijarta-information-system',
    title: 'SIJARTA Information System',
    description: 'Information system project emphasizing secure backend development, relational modeling, and database optimization.',
    longDescription: 'Built SIJARTA with Django REST Framework and PostgreSQL, focusing on secure coding practices, API design, and SQL query optimization. The project centered on building a maintainable information system with robust data flows and stronger backend discipline.',
    technologies: ['Django REST Framework', 'PostgreSQL', 'Secure Coding', 'SQL Optimization', 'Backend Development'],
    category: 'web',
    image: '/images/projects/sijarta-information-system.png',
    githubUrl: 'https://github.com/rakabimar/Proyek-SIJARTA',
    featured: true,
    status: 'completed'
  },
  {
    id: 'kaffah-chicken-workflow-automation',
    title: 'Kaffah Chicken Workflow Automation',
    description: 'Workflow automation system connecting forms, POS data, and messaging flows for operational efficiency.',
    longDescription: 'Automated business workflows for Kaffah Chicken using n8n, integrating Google Forms, Olsera POS, and Telegram notifications. The workflow handled process orchestration, duplicate suppression, and reduced manual operational overhead across recurring tasks.',
    technologies: ['n8n', 'Google Forms', 'Olsera POS', 'Telegram', 'Systems Integration'],
    category: 'other',
    image: '/images/projects/kaffah-chicken-workflow-automation.png',
    liveUrl: 'https://drive.google.com/file/d/1QOy91uyku1tRBeFsT-GlWVyfhCc_KC9g/view?usp=sharing',
    featured: false,
    status: 'completed'
  },
  {
    id: 'ufc-predictive-analytics',
    title: 'UFC Predictive Analytics',
    description: 'Machine learning project for analyzing and predicting UFC fight outcomes through applied data science workflows.',
    longDescription: 'Built a predictive analytics project around UFC datasets using Python, exploratory data analysis, and multiple machine learning approaches. The work covered classification, regression, and clustering to derive patterns from fighter and bout-level data.',
    technologies: ['Python', 'EDA', 'Machine Learning', 'Classification', 'Regression', 'Clustering'],
    category: 'ai',
    image: '/images/projects/ufc-predictive-analytics.png',
    githubUrl: 'http://ristek.link/AI-DS-Project',
    featured: false,
    status: 'completed'
  }
]
